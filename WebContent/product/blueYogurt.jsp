	        ...
	        <div class="col-lg-6 prod-right">
	              ...
	              <% for(ProductDTO product:productList) { %>
	                    ...
	                    <p class="wow fadeInUp" data-wow-delay="0.2s">NO.1 유산균으로 만든 건강하고 맛있는 요거트.
                              <br>건강한 유산균에 달콤한 블루베리 첨가로 더 맛있는 블루베리 요거트.</p>
...
<div class="proDetail" id="proDetail1">
	...
	<table class="milkForm">
		...
		<tbody>
			...
			<tr>
				<th>원재료 및 함량</th>
				<td>원유(국산), 블루베리시럽 20%[정백당, 블루베리 30%(미국산), 아미드펙틴, 변성전분, 합성착향료(블루베리향)], 정제수, 혼합탈지분유(네덜란드산), 정백당, 유단백분말, 아미드펙틴, 젤라틴, 유산균(S. thermophilus, L. acidophilus, Bifidobacterium, L-GG) 5억이상/g</td>
			</tr>
			<tr>
				<th>고객상담실 연락처</th>
				<td>1588-1588</td>
