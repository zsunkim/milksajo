	  ...
	  <div class="row product-sec">
	        ...
	        <div class="col-lg-6 prod-right">
	              ...
	              <% for(ProductDTO product:productList) { %>
	                    ...
	                    <p class="wow fadeInUp" data-wow-delay="0.2s">NO.1 유산균으로 만든 건강하고 맛있는 요거트.</p>
	                    <br>
...
<div class="proDetail" id="proDetail1">
	...
	<table class="milkForm">
		...
		<tbody>
			...
			<tr>
				<th>원재료 및 함량</th>
				<td>원유 96%(국산), 혼합탈지분유(네덜란드산), 유크림(국산), 유단백분말, 피쉬젤라틴, 유화제, 유산균(S. thermophilus, L. bulgaricus, L-GG)5억이상/g</td>
			</tr>
			<tr>
				<th>고객상담실 연락처</th>
				<td>1588-1588</td>
